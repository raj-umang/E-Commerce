    ...
    var Reveal = {
        ...
        revealWhy: function() {
            s.$why.one('inview', function() {
                $('.left-info-block').find(s.$why).velocity('transition.slideLeftBigIn', {
                    stagger: 200,
                    delay: 100,
                    duration: 1000
                });
                $('.right-info-block').find(s.$why).velocity('transition.slideRightBigIn', {
                    stagger: 200,
                    delay: 100,
                    duration: 1000
                });
        ...
        revealList: function() {
            $('.stats-in-number').one('inview', function() {
                s.$stats.velocity('transition.bounceIn', {
                    stagger: 100,
                    delay: 100
                });
            });
