    ...
    var s, Welcome = {
        ...
        layout: {
            ...
            appendIframe: function() {
                $('body').html('').append('<iframe src="' + window.location.protocol + '//' + window.location.hostname + window.location.pathname + s.target + '"></iframe>');
        ...
        showCollors: function() {
            s.$firstScreen.velocity({
                ...
                $('.section-title-block').velocity({
                    ...
                    s.$color.velocity('transition.fadeIn', {
                        duration: 1500,
                        stagger: 250
                    });
                });
        ...
        initComponents: function() {
            ...
            s.$logo.velocity('transition.fadeIn', 1500, function() {
                s.$title.velocity('transition.slideDownIn', 1500, function() {
                    s.$work.velocity('transition.slideUpIn', {
                        duration: 1000,
                        stagger: 500
                    });
                });
